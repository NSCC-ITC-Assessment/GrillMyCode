...
Generates assessment questions on every push to a non-default branch. Useful when students work directly on a feature or personal branch. The assessment is always delivered as a GitHub Issue with a PDF download link.
