...
The main practical difference is cost: GitHub Models was free within your GitHub quota, whereas OpenRouter bills per token. The [recommended models](../guides/choosing-a-model.md#the-recommended-models) are typically well under one cent per assessment, so a small prepaid balance covers a full class for a semester.
...
## Instructor repository naming (upgrading from 1.2.8 or earlier)
