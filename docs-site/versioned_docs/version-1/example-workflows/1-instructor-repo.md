...
- Files written per student: `student-login/questions.md`, `student-login/cs-principles-hello_student-login_quiz.imscc`, and — as an alternative for Brightspace users only — `student-login/cs-principles-hello_student-login_brightspace_quiz.csv`
