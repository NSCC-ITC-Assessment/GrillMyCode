...
Students may submit code they do not fully understand — copied from a peer, generated by an AI assistant, or adapted from Stack Overflow without internalising what it does. A submitted repository that passes automated tests says nothing about whether the student who wrote it can explain it.
