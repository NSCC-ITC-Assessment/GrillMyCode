...
Confirmed vulnerabilities will be patched and released as a patch version on all active major lines. See [versioning.md](https://grillmycode.org/docs/development/versioning) for the release process.
