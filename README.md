...
| `include_initial_commit`       | No       | `false`                                     | When `false` (default), pins the diff base to the first commit so starter/template files are excluded. When `true`, uses the empty tree as the base so the initial commit's files are included in the diff regardless of event type.                                                                                                                                                                                                                                                                                                                         |
