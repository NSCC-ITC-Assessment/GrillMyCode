...
- Write the correct answer first. Then write each distractor so its word count is no more than 20% SHORTER than the correct answer's word count. There is no upper bound on distractor length.
